...
DECLARE_TRAP(CAUSE_INT_OVERFLOW, int_overflow_fault)
DECLARE_TRAP(CAUSE_INT_DIV_ZERO, int_div_zero_fault)
DECLARE_TRAP(CAUSE_INVALID_CALL_TAG, call_tag_fault)
DECLARE_TRAP(CAUSE_INVALID_INDIRECT_TAG, indirect_tag_fault)
DECLARE_TRAP(CAUSE_INVALID_RETURN_TAG, return_tag_fault)
#endif
